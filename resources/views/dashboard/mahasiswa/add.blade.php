                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="nik" class="form-control" id="exampleInputEmail1" placeholder="Enter NIK">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="no_telpon" class="form-control" id="exampleInputEmail1" placeholder="Enter No.Telephone">
                            </div>
                            <div class="form-group">
                                <!-- <label>Alamat</label> -->
